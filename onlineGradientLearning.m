...
%   validationSetE : Errore relativo al validation set.
    ...
    for n = 1 : size(trainingSetInput, 1)
        ...
        % Aggiornamento dell'errore totale
        sumTrainingSetE = sumTrainingSetE + trainingSetE;
        sumValidationSetE = sumValidationSetE + validationSetE;
    ...
    trainingSetE = sumTrainingSetE;
    validationSetE = sumValidationSetE;
end
